...
from .models import *
from dailyentry.models import customer_qr_code, DailyEntry
...
class CustomerDetailNestedSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Customer
        fields = [
            'id', 'first_name', 'last_name', 'sequence_no', 
            'phone_no', 'route', 'rate', 'date_added',
            'active', 'customer_account', 'bills', 
            'daily_entries', 'daily_entry_monthly',
            'payments', 'qr_code'
        ]
